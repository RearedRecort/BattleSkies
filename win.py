...
class WinView(arcade.View):
    def __init__(self, kills_friends, kills_enemy, time):
        super().__init__()
        ...
        self.setup_widgets(kills_friends, kills_enemy, time, 3 * kills_enemy - 2 * kills_friends)  # Функция ниже
    ...
    def setup_widgets(self, kills_friends, kills_enemy, time, money):
